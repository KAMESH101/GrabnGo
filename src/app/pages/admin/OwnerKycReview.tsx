...
import { CheckCircle, XCircle, Clock, AlertTriangle, Store, FileText, Zap } from 'lucide-react';
...
export const OwnerKycReview: React.FC = () => {
    ...
    const loadData = () => {
        const allSubmissions = getKycSubmissionsByRole('owner');
    ...
    const handleApprove = async (submission: KycSubmission) => {
        ...
        try {
            ...
            toast.success('Owner KYC approved successfully');
            loadData();
        } catch (error) {
    ...
    const handleRejectConfirm = async () => {
        ...
        try {
            ...
            toast.success('Owner KYC rejected');
    ...
    const pendingCount = getKycSubmissionsByStatus('pending').filter(s => s.role === 'owner').length;
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900">Owner KYC Review</h1>
                    ...
                    {submissions.length === 0 ? (
                        <Card>
                            <CardContent className="pt-6 text-center text-gray-500">
                                No {filterStatus !== 'all' && filterStatus} owner KYC submissions found
                            </CardContent>
                        </Card>
                    ) : (
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    {submittedUser?.roles?.includes('customer') && (
                                                        <a
                                                            href={`/admin/kyc/customer?userId=${submittedUser.id}`}
                                                            className="text-xs text-indigo-600 hover:text-indigo-700 mt-1 inline-block"
                                                        >
                                                            Customer KYC: {submittedUser.customerKycStatus || 'not_submitted'}
                                                        </a>
                                                    )}
                                                </div>
                                            </div>
